 ...
 *
 * Log field incidents and assign them to a response team. Incidents are
 * events, so the queue starts empty; the admin reports them and dispatches a
 * team straight from the table. Status advances new → assigned → in-progress
 * → resolved. Records live in component state until the incidents API
 * (Conceptual Framework) is wired in.
 */
    ...
    <AdminLayout>
      <div className="mng">
        ...
        <div className="mng-note">
          <SparkIcon />
          <span>Assigning a team moves an incident to “Assigned”. Records are kept for this session until the backend is connected.</span>
        </div>
      </div>
